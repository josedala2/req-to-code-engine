...
const producerData: Record<string, any> = {
  "1": {
    ...
    history: "Fundada em 1985, a Fazenda Santa Clara é pioneira na produção de cafés especiais na região de Carmo de Minas. Com foco em sustentabilidade e qualidade, a fazenda implementou práticas orgânicas desde 2005.",
    production: {
      annual: "2.500 sacas",
      quality: "85% Premium, 15% Gourmet",
      mainMarkets: ["Europa", "Japão", "Estados Unidos"],
    },
    infrastructure: {
